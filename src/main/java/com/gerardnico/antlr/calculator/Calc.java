 ...
 * of <a href="http://www.pragmaticprogrammer.com/titles/tpantlr2">The Definitive ANTLR 4 Reference
 * by Terence Parr</a>
 *
 *
 ...
 *   * articles,
 *   * and the like.
 * Contact them if you are in doubt.
 * We make no guarantees that this code is fit for any purpose.
 * Visit http://www.pragmaticprogrammer.com/titles/tpantlr2 for more book information.
 *
***/
package com.gerardnico.antlr.calculator;
...
public class Calc {
    public static void main(String[] args) throws Exception {
		...
		CalcParser parser = new CalcParser(null); // share single parser instance
